...
def convert_to_wxo_tool_spec(mcp_cf_tool):
    '''
    Method convert MCP tool json format to toolops specific internal format
    '''
...
def post_process_nl_test_cases(nl_test_cases):
    '''
    method for post processing the generated test cases by removing unwanted fields
    '''
