...
class TestBootstrapAdminUser:
    ...
    @pytest.mark.asyncio
    async def test_bootstrap_admin_user_already_exists(self, mock_settings, mock_db_session, mock_email_auth_service, mock_admin_user):
...
class TestBootstrapDefaultRoles:
    ...
    @pytest.mark.asyncio
    async def test_bootstrap_roles_no_admin_user(self, mock_settings, mock_email_auth_service, mock_role_service):
    ...
    @pytest.mark.asyncio
    async def test_bootstrap_roles_create_success(self, mock_settings, mock_email_auth_service, mock_role_service, mock_admin_user):
...
class TestBootstrapResourceAssignments:
    ...
    @pytest.mark.asyncio
    async def test_resource_assignments_no_personal_team(self, mock_settings, mock_db_session, mock_admin_user):
    ...
    @pytest.mark.asyncio
    async def test_resource_assignments_success(self, mock_settings, mock_db_session, mock_admin_user, mock_personal_team):
    ...
    @pytest.mark.asyncio
    async def test_resource_assignments_no_orphans(self, mock_settings, mock_db_session, mock_admin_user, mock_personal_team):
    ...
    @pytest.mark.asyncio
    async def test_resource_assignments_exception(self, mock_settings, mock_db_session):
